    ...
    (() => {
        ...
        let bodyLock = (delay = 500) => {
            ...
            if (bodyLockStatus) {
                ...
                for (let index = 0; index < lock_padding.length; index++) {
                    const el = lock_padding[index];
                    el.style.paddingRight = window.innerWidth - document.querySelector(".betnero_wrapper").offsetWidth + "px";
                }
                body.style.paddingRight = window.innerWidth - document.querySelector(".betnero_wrapper").offsetWidth + "px";
        ...
        function menuInit() {
            if (document.querySelector(".betnero_icon-menu")) document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest(".betnero_icon-menu")) {
                    bodyLockToggle();
                    document.documentElement.classList.toggle("betnero_menu-open");
                }
            }));
        }
        function functions_menuClose() {
            bodyUnlock();
            document.documentElement.classList.remove("betnero_menu-open");
        }
        function showMore() {
        ...
        function initSliders() {
            if (document.querySelector(".betnero_promotions__slider")) new core(".betnero_promotions__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
            ...
            if (document.querySelector(".betnero_bonus__slider")) new core(".betnero_bonus__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
            ...
            if (document.querySelector(".betnero_provider__slider")) new core(".betnero_provider__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
            ...
            if (document.querySelector(".betnero_tabs__slider")) new core(".betnero_tabs__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
                ...
                loop: false,
                navigation: {
                    prevEl: ".betnero_tabs-button-prev",
                    nextEl: ".betnero_tabs-button-next"
                },
                on: {}
            });
            if (document.querySelector(".games-thumbs__slider-1")) new core(".games-thumbs__slider-1", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
                ...
                loop: false,
                navigation: {
                    prevEl: ".betnero_swiper-button-prev-1",
                    nextEl: ".betnero_swiper-button-next-1"
                },
                on: {}
            });
            if (document.querySelector(".games-thumbs__slider-2")) new core(".games-thumbs__slider-2", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
                ...
                loop: false,
                navigation: {
                    prevEl: ".betnero_swiper-button-prev-2",
                    nextEl: ".betnero_swiper-button-next-2"
                },
                on: {}
            });
            if (document.querySelector(".games-thumbs__slider-3")) new core(".games-thumbs__slider-3", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
                ...
                loop: false,
                navigation: {
                    prevEl: ".betnero_swiper-button-prev-3",
                    nextEl: ".betnero_swiper-button-next-3"
                },
                on: {}
            });
            if (document.querySelector(".games-thumbs__slider-4")) new core(".games-thumbs__slider-4", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
                ...
                loop: false,
                navigation: {
                    prevEl: ".betnero_swiper-button-prev-4",
                    nextEl: ".betnero_swiper-button-next-4"
                },
                on: {}
            });
            if (document.querySelector(".games-thumbs__slider-5")) new core(".games-thumbs__slider-5", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
                ...
                loop: false,
                navigation: {
                    prevEl: ".betnero_swiper-button-prev-5",
                    nextEl: ".betnero_swiper-button-next-5"
                },
                on: {}
            });
            if (document.querySelector(".games-thumbs__slider-6")) new core(".games-thumbs__slider-6", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
                ...
                loop: false,
                navigation: {
                    prevEl: ".betnero_swiper-button-prev-6",
                    nextEl: ".betnero_swiper-button-next-6"
                },
                on: {}
            });
            if (document.querySelector(".games-thumbs__slider-7")) new core(".games-thumbs__slider-7", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
                ...
                loop: false,
                navigation: {
                    prevEl: ".betnero_swiper-button-prev-7",
                    nextEl: ".betnero_swiper-button-next-7"
                },
                on: {}
            });
            if (document.querySelector(".games-thumbs__slider-8")) new core(".games-thumbs__slider-8", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
                ...
                loop: false,
                navigation: {
                    prevEl: ".betnero_swiper-button-prev-8",
                    nextEl: ".betnero_swiper-button-next-8"
                },
                on: {}
            });
        }
        ...
        const footerNav = document.querySelector(".betnero_footer__navigation");
        if (footerNav) {
            const elements = footerNav.querySelectorAll(".betnero_first_line");
            const navWidth = footerNav.offsetWidth;
            let sum = 0;
            for (let i = 0; i < elements.length; i++) {
                const elementWidth = elements[i].scrollWidth + 25;
                sum += elementWidth;
                if (sum > navWidth) {
                    elements[i].classList.add("betnero_second_line");
                    elements[i].classList.remove("betnero_first_line");
                }
            }
            const elements2 = footerNav.querySelectorAll(".betnero_second_line");
            let sum2 = 0;
            for (let i = 0; i < elements2.length; i++) {
                const elementWidth = elements2[i].scrollWidth + 25;
                sum2 += elementWidth;
                if (sum2 > navWidth) {
                    elements2[i].classList.add("betnero_third_line");
                    elements2[i].classList.remove("betnero_second_line");
                }
            }
            const elements3 = footerNav.querySelectorAll(".betnero_third_line");
            let sum3 = 0;
            for (let i = 0; i < elements3.length; i++) {
                const elementWidth = elements3[i].scrollWidth + 25;
                sum3 += elementWidth;
                if (sum3 > navWidth) {
                    elements3[i].classList.add("betnero_fourth_line");
                    elements3[i].classList.remove("betnero_third_line");
                }
            }
            const elements1line = footerNav.querySelectorAll(".betnero_first_line");
            const elements2line = footerNav.querySelectorAll(".betnero_second_line");
            const elements3line = footerNav.querySelectorAll(".betnero_third_line");
            const elements4line = footerNav.querySelectorAll(".betnero_fourth_line");
            for (let i = 0; i < elements1line.length - 1; i++) elements1line[i].classList.add("betnero_separator");
            for (let i = 0; i < elements2line.length - 1; i++) elements2line[i].classList.add("betnero_separator");
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            const responsiveBlock = document.querySelector(".betnero_bottom-block");
        ...
        const script_button = document.getElementById("betnero_prova");
        if (script_button) script_button.addEventListener("click", (function() {
            const gameWrapperElement = document.querySelector(".betnero_game-wrapper");
            if (gameWrapperElement) gameWrapperElement.classList.add("betnero_unblock-game");
        }));
        const buttonFullScreen = document.getElementById("betnero_fullscreen_btn");
        if (script_button) buttonFullScreen.addEventListener("click", (function() {
            const gameWrapperElement = document.querySelector(".betnero_game-wrapper");
            if (gameWrapperElement) {
                gameWrapperElement.classList.add("betnero_unblock-game");
                gameWrapperElement.classList.toggle("betnero_fullscreen");
            }
        }));
        if (document.getElementsByClassName("betnero_form-item").length === 0) console.log("Элементы не найдены"); else {
            const inputs = document.getElementsByClassName("betnero_form-item");
            for (let i = 0; i < inputs.length; i++) inputs[i].addEventListener("input", (function() {
                const isInput1Empty = inputs[0].value === "";
                const isInput2Empty = inputs[1].value === "";
                if (!isInput1Empty && !inputs[0].classList.contains("betnero_filled-item")) inputs[0].classList.add("betnero_filled-item"); else if (isInput1Empty && inputs[0].classList.contains("betnero_filled-item")) inputs[0].classList.remove("betnero_filled-item");
                if (!isInput2Empty && !inputs[1].classList.contains("betnero_filled-item")) inputs[1].classList.add("betnero_filled-item"); else if (isInput2Empty && inputs[1].classList.contains("betnero_filled-item")) inputs[1].classList.remove("betnero_filled-item");
                const isInput1Filled = inputs[0].classList.contains("betnero_filled-item");
                const isInput2Filled = inputs[1].classList.contains("betnero_filled-item");
                const button = document.getElementsByClassName("betnero_form-btn")[0];
                if (isInput1Filled && isInput2Filled) button.classList.add("betnero_button-unlock"); else button.classList.remove("betnero_button-unlock");
            }));
        }
        var script_form = document.getElementById("betnero_login-form");
        var betnero_form_button = document.getElementsByClassName("betnero_form-btn")[0];
        script_form.addEventListener("submit", (function(event) {
            if (betnero_form_button.classList.contains("betnero_button-unlock")) ; else event.preventDefault();
        }));
        window["FLS"] = false;
        menuInit();
        showMore();
