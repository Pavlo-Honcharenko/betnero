(() => {
    ...
    (() => {
        ...
        const b_button = document.querySelector(".betnero_filters-button");
        const b_filters = document.querySelector(".betnero_games__filters");
        const b_close = document.querySelector(".betnero_filters_close");
        if (b_button && b_filters && b_close) {
            function toggleFilters() {
                b_filters.classList.toggle("betnero_filters_open");
            }
            b_button.addEventListener("click", toggleFilters);
            b_close.addEventListener("click", (function() {
                b_filters.classList.remove("betnero_filters_open");
            }));
        }
        window["FLS"] = false;
        menuInit();
